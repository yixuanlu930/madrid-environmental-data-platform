...
def run_pipeline(target_day: date | None = None) -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        "status": "running",
        "date": day_string,
        "coordinates": {"latitude": settings.latitude, "longitude": settings.longitude, "timezone": settings.timezone},
        "sources": [],
        "selected_variables": {"historical_weather": settings.weather_hourly_variables, "air_quality": settings.air_quality_hourly_variables},
        "outputs": [],
        "uploaded_to_minio": [],
        "row_counts": {},
        "errors": [],
    ...
    try:
        ...
        long_rows = wide_rows_to_long_rows(weather_rows, settings.weather_hourly_variables) + wide_rows_to_long_rows(air_rows, settings.air_quality_hourly_variables)
        ...
        manifest["uploaded_to_minio"] = upload_pipeline_outputs(data_dir, day_string)
        manifest["row_counts"] = {
...
def main() -> int:
    ...
    manifest = run_pipeline(parse_date(args.date))
    print(manifest)
